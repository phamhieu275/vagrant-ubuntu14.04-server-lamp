    ...
    <div class="container">
        ...
        <table class="table table-striped">
            ...
            <tr>
                <td>xDebug</td>
                <td>
                    <i class="fa fa-<?php echo (function_exists('xdebug_get_code_coverage') ? 'check' : 'remove'); ?>">
                    </i>
                </td>
            </tr>
        </table>
        ...
        <table class="table table-striped">
            ...
            <tr>
                <td colspan="2"><em>Note: External access is enabled! Just use <strong>
                <?php echo $_SERVER['SERVER_ADDR'] ?></strong> as host.</em></td>
            </tr>
        </table>
        ...
        <table class="table table-striped">
            <tr>
                <td>URL</td>
                <td>http:://<?php echo $_SERVER['SERVER_ADDR'] ?>/phpmyadmin</td>
            </tr>
...
<div id="footer">
    <div class="container">
        <p class="muted credit">
            <div class="pull-left">
                <a href="https://github.com/matmaxanh/Vagrant-LAMP-Stack" target="_blank">
                    DevSpace Vagrant 
                </a> by <a href="https://github.com/matmaxanh" traget="_blank">Bluecode</a>.
            </div>
        </p>
    </div>
</div>
